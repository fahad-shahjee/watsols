...
<head>
    ...
    <title>Our Team - Digital Marketing Agency</title>
            ...
            <div class="banner-layout-wrapper">
                <div class="banner-layout">
                    <div class="d-flex flex-column text-center align-items-center gspace-2">
                        <h2 class="title-heading animate-box animated animate__animated" data-animate="animate__fadeInRight">Meet Our Team</h2>
                        ...
                        <div class="row row-cols-xl-3 row-cols-md-2 row-cols-1 g-4">
                            <div class="col">
                                <div class="d-flex flex-column">
                                    <div class="image-team">
                                        <img src="assets/image/dummy-img-600x800.jpg" alt="Team Image" class="img-fluid">
                            ...
                            <div class="col">
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="team-profile">
                                        <h4>Daniel White</h4>
                                        <span class="title">Client Success Manager</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
